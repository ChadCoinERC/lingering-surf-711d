...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-surf-711d
```

A live public deployment of this template is available at [https://lingering-surf-711d.templates.workers.dev](https://lingering-surf-711d.templates.workers.dev)
